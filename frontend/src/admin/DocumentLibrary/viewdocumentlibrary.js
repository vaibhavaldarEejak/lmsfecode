        ...
        <CCol xs={12}>
          <CCard className="mb-4">
              ...
              <CModalBody>
                <div style={scrollableContainerStyle}>
                  ...
                  <Player
                    extension={extension}
                    documentLibraryLink={certificateDetail.documentLibraryLink}
                    documentLibraryTitle={certificateDetail.documentLibraryTitle}
                  />
                </div>
              </CModalBody>
              <CModalFooter>
            ...
            <CCardBody className="card-body border-top p-9">
              ...
              <CForm className="row g-15 needs-validation ps-4" form={form} onFinish={doccumentdetailApi}>

                <CCol lg={12} className="d-flex flex-wrap align-items-center" style={{ marginBottom: "20px" }}>
                  {/* Document Name */}
                ...
                <CRow className="mb-3">
                  <CCol lg={12}>
                    ...
                    <div className="py-2">
                      {removeHtmlTags(certificateDetail.documentLibraryDescription)}
                ...
                <CRow className="mb-3">
                  <CCol lg={12}>
                    ...
                    <div className="py-2">
                      {certificateDetail.categoryName}
                    </div>
                  </CCol>
                </CRow>
                ...
                <CRow className="mb-3">
                  <CCol lg={12} className="d-flex flex-wrap align-items-center">
                    ...
                    <div className="py-2" style={{ marginRight: "10px", marginBottom: "5px" }}>
