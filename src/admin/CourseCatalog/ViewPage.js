        ...
        <CCol xs={12}>
          <CCard className="mb-4">
            ...
            <CCardBody className="card-body org border-top p-9">
              <CModal visible={quizVisible} onClose={() => setQuizVisible(false)} size="lg">
                <CModalHeader>
                ...
                <CModalBody>
                  <div className="container">
                              ...
                              <div className="card">
                                {e?.questionType === "Text Answer" ||
                                  ...
                                  <div className="card-body">
                                    ...
                                    {e?.answer &&
                                      e?.answer.map((ans) => (
                                        <div className="form-group" key={ans.value}>
                                  ...
                                  <div className="card-body">
                                    ...
                                    {e?.answer &&
                                      e?.answer.map((ans) => (
                                        <div className="form-check" key={ans.value}>
                                          <input
                                            ...
                                            disabled
                                          />
                                          <label className="form-check-label">{ans.label}</label>
                                        </div>
                                      ))}
                                  </div>
                                )}
                            ...
                            <div className="col-md-3">
                              <div className="card">
                                <div className="card-body d-flex align-items-center">
                                  ...
                                  <p className="card-text mb-0" style={{ marginTop: "-5px" }}>{e?.questionScore}</p>
                                </div>
                              </div>
                            </div>
                          </div>
                    ...
                    ) : courseDetail?.displayType === 1 && courseDetail?.questionAnswer ? (
                      /* List view modal */
                      <CModalBody>
                        <div className="container">
                            ...
                            <div className="row" key={idx}>
                              ...
                              <div className="col-md-3">
                                <div className="card my-2">
                                  <div className="card-body d-flex align-items-center">
                                    <h5 className="card-title me-2">Score:</h5>
                                    <p className="card-text mb-0" style={{ marginTop: "-1px" }}>{question?.questionScore}</p>
                                  </div>
                                </div>
                              </div>
                            </div>
              ...
              >
                ...
                <CRow className="mb-3">
                  ...
                  <CCol md={6} style={{ width: "500px", marginLeft: "auto", marginTop: "-205px" }}>
                    <Card
                  ...
                  <CCol md={6}>
                    {courseDetail.questionAnswer && (
                      <CRow className="mb-3">
                        ...
                        <div className="col-sm-7 py-2" style={{ marginRight: '500px' }}>
                          <CButton
