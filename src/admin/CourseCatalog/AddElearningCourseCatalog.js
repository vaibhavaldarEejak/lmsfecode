  ...
  useMemo(() => {
    if (learningDetails) {
      setForm({
        ...
        creditVisibility: learningDetails.creditVisibility,
                            ...
                            <CRow className="mb-3">
                              ...
                              <div className="col-sm-7">
                                <CFormInput
                                  ...
                                  onChange={(e) => {
                                    ...
                                    setValidationMessages({
                                      ...validationMessages,
                                      referenceCode: e.target.value ? "" : "Training ID is required",
                                    });
                                  }}
                                />
                                {showValidationMessages &&
                              ...
                              <div className="col-sm-1 py-1">
                                <CImage
                                  ...
                                  className="me-2"
                                  onClick={() => {
                                    const newCourseCode = generateRandomCourseId();
                                    setForm({
                                      ...form,
                        ...
                        <CRow className="mb-3">
                          ...
                          <div className="col-sm-7 py-2">
                            <CFormCheck
                              ...
                              onChange={(e) =>
                                setForm({ ...form, sslForAicc: e.target.value })
                              }
                            />
                            <CFormCheck
                              inline
