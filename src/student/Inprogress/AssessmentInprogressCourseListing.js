...
const inprogress = () => {
  ...
  const getInProgressListing = async () => {
    try {
      ...
      setCourses(res);
      const filteredData = res.filter((items) => items.trainingTypeId === 3);
  ...
  useEffect(() => {
    if (optionalPara === "Assessment") {
      setResponseData(classroom);
    }
  }, [classroom]);
                        ...
                        <a
                          ...
                          onClick={() => {
                            ...
                            if (item.contentType === "SCORM") {
                              ...
                              setmediaUrl(item?.trainingMedias[0]?.mediaUrl);
                              setextension(item?.trainingMedias[0]?.mediaType);
            ...
            <div>
              <CCardHeader className="p-0">
                <CNav variant="tabs">
                  ...
                  <CNavItem>
                    <Link
                      to={"/student/assessmentinprogress?Assessment"}
                      style={{ textDecoration: "none" }}
                    >
                      <CNavLink
                        active={courseType === "Assessment" ? true : false}
                          ...
                          body={(rowData) => (
                            <div className="button-container ">
                              <Button
                                ...
                                onClick={() => {
                                  navigate(
                                    `/student/view-detail?${rowData.courseLibraryId}`
                                  );
                                }}
                              />
