  ...
  const buttonTemplate = (responseData) => (
    <div style={{ display: "flex" }}>
      ...
      <div>
        ...
        <div
          onClick={() => moveItemUp(responseData)}
          disabled={isFirstItem(responseData)}
          title="Move Up"
          style={{ cursor: "pointer" }}
        ><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-arrow-up-square-fill" viewBox="0 0 16 16">
      ...
      <div
        onClick={() => moveItemDown(responseData)}
        disabled={isLastItem(responseData)}
        title="Move Down"
        style={{ cursor: "pointer" }}
      >
