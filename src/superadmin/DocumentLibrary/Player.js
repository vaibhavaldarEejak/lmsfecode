...
const Player = (props) => {
  ...
  if (
    ...
    return (
      <iframe
        src={`https://view.officeapps.live.com/op/embed.aspx?src=${props.documentLibraryLink}`}
    ...
    return (
      <video controls="controls" width={"100%"} height={"100%"}>
        <source src={props.documentLibraryLink} type="video/mp4"></source>
      </video>
    );
  } else if (
    props.extension === ".mp3" ||
    ...
    return (
      <audio controls="controls">
        <source src={props.documentLibraryLink} type="audio/mpeg"></source>
      </audio>
    );
  } else if (props.extension === ".csv" || props.extension === ".txt") {
    return (
      <iframe
        src={`https://docs.google.com/gview?url=${props.documentLibraryLink}&embedded=true`}
        style={{ height: "900px", width: "750px" }}
      />
    );
        ...
        <ScormProvider debug={true}>
          <div className="d-flex justify-content-center">
            <iframe
              ...
              style={{ height: "900px", width: "750px" }}
              src={`/media/${props.documentLibraryFilename}/index_lms.html`}
            ></iframe>
          </div>
        </ScormProvider>
      </React.StrictMode>
